...
In my search for the perfect book tracker, I stumbled upon [Literal](https://literal.club/). It’s like Goodreads, but their UI is from this century *and* they have an open GraphQL API. It’s like they knew I wanted to show off.
...
For type info, you can define these models (and any other fields you want to use, full list [here](https://literal.club/pages/api "Literal Club API Documentation")).
