...
\[^1]: [https://www.spooklore.com/writing/moving](https://www.spooklore.com/writing/moving)

\[^2]: [https://contentlayer.dev/](https://contentlayer.dev/)

\[^3]: [https://github.com/jpmonette/feed](https://github.com/jpmonette/feed)

\[^4]: [https://nextjs.org/docs/app/building-your-application/routing/route-handlers](https://nextjs.org/docs/app/building-your-application/routing/route-handlers)
