...
tags: []
---
I was recently promoted at \[Hugo Health]\(https\://hugo.health) from Software Engineer I (the equivalent of a junior-level position at the company) to Software Engineer II. Being a part of a small startup has allowed me to grow and become more knowledgable
...
those around you, or that you don't deserve to be there. All this anxiety is in spite of one's competence and success.

Almost *every* junior developer, or junior level worker in any industry, feels this way at some point within their
...
day *shortened* my workday. Maybe not immediately, but over time. Instead of reading documentation or resources that
...
* what you are actually receiving from the code
...
For example, say you're making chicken parmesan over pasta for dinner.
...
Simple example, but it's a simple concept that divides large problems into manageable tasks. It's a great skill to have,
...
Technology, specifically software engineering, is \_not\_ a field known for having many women. I remember walking into
...
I'm not implying that \_only\_ women struggle with imposter syndrome, rather, it's much more likely that a woman
...
If you're interested in helping to close the gender gap, you can visit organizations like \[Girls Who Code]\(https\://girlswhocode.com/) to get involved in the community of women in software engineering.
