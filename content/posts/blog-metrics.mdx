...
## Connecting Planetscale to Prism
...
> ✨ **Note**: this next part assumes you followed the [last part of this series](<\> https://www.emmacampbell.dev/blog/blog-content-layer>) that set up content using contentlayer
