...
I keep many of my helper methods in a directory called `/lib`. There, we are going to create a new file called `prisma.ts`. Our goal with this helper is to follow the [best Next.js practices](https://pris.ly/d/help/next-js-best-practices) according to Prisma.
