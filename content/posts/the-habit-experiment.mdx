...
An external interrupter provides an **intrusive** cue for whatever task you are trying to accomplish. Because these interruptions can be jarring, it is good to reserve them for _time-sensitive_ tasks, so you aren't interrupting any flow states.
...
_[Decision fatigue](https://en.wikipedia.org/wiki/Decision_fatigue "Decision Fatigue — Wikipedia")_ is a psychology concept that says the more decisions someone makes in a day, the more physically, mentally, and emotionally drained they become. Because, let's face it. Decisions use a lot of cognitive and executive functioning skills, and people with ADHD already have a difficult time with these to begin with.
...
decisions that drain the do-power tank. So maybe, don't put things you're avoiding at the end of the day, because you'll likely
keep avoiding them.
