...
export interface Config {
  ...
  collectionsSelect: {
    ...
    notebook: NotebookSelect<false> | NotebookSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "notebook_select".
 */
export interface NotebookSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  slug?: T;
  updatedAt?: T;
