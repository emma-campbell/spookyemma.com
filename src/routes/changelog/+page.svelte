...
<svelte:head>
	...
	<meta
		name="description"
		content="What's changed on this site — new posts, fixes, redesigns, and version milestones."
	/>
</svelte:head>
...
<PageShell>
	...
	<div class="page-header-row">
		...
		<div class="page-header-content">
			...
			<p class="page-lede">
				What's changed on this site — new posts, fixes, redesigns, and version milestones. Most
				recent first.
			</p>
		</div>
		<div class="page-header-aside">
			<div class="legend">
				<div class="legend-item">
					<span class="legend-dot" style="background:var(--sage)"></span><span
						style="color:var(--sage)">added</span
					> — new content or features
				</div>
				<div class="legend-item">
					<span class="legend-dot" style="background:var(--amber)"></span><span
						style="color:var(--amber)">changed</span
					> — modifications
				</div>
				<div class="legend-item">
					<span class="legend-dot" style="background:var(--coral)"></span><span
						style="color:var(--coral)">fixed</span
					> — bug fixes
				</div>
				<div class="legend-item">
					<span class="legend-dot" style="background:var(--lavender)"></span><span
						style="color:var(--lavender)">meta</span
					> — versions &amp; milestones
				</div>
			</div>
		</div>
			...
			<div class="month-aside">
				{#each Object.entries(counts) as [tag, count]}
					<div class="month-stat">
						<span class="month-stat-dot" style="background:{tagColors[tag] || 'var(--muted)'}"
						></span>
						<span class="month-stat-count">{count}</span>
						{tag}
					</div>
				{/each}
			</div>
